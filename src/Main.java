public class Main {
    ...
    public static void main(String[] args) {
        ...
        Service streaming = new StreamingService("StreamPlus", 101,100);
        Service cloud = new CloudStorageService("CloudBox", 102,109);
        Service consultation = new ConsultationService("MediTalk", 103,200);
